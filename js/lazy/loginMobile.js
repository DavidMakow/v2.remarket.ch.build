...
exports.HeaderAllPages = undefined;
...
var _agb = __webpack_require__(665);

var _agb2 = _interopRequireDefault(_agb);
...
var HeaderAllPages = exports.HeaderAllPages = function (_Component) {
    (0, _inherits3.default)(HeaderAllPages, _Component);

    function HeaderAllPages(props) {
        (0, _classCallCheck3.default)(this, HeaderAllPages);

        var _this = (0, _possibleConstructorReturn3.default)(this, (HeaderAllPages.__proto__ || Object.getPrototypeOf(HeaderAllPages)).call(this, props));
        ...
        _this.valueSelected = function (item) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    null,
                    _react2.default.createElement('img', { loading: 'lazy', alt: '', src: '/images/' + item.id + '.svg', style: { marginRight: '5px' } })
                ),
                _react2.default.createElement(
                    'div',
                    null,
    ...
    (0, _createClass3.default)(HeaderAllPages, [{
        ...
        value: function _loadPersonalData(token) {
            ...
            if (token) {
                _axios2.default.get('/api/customerAgileData').then(function (data) {
                    ...
                    document.getElementById("op").checked = false;
                    if (data.status === 200) {
                        var redirectUrl = _this2.props.user.redirectTo,
                            cancelRedirectTo = _this2.props.user.cancelRedirectToMyAccount;
                        _this2.closeLoginForm();
                        _this2.props.userActions.loginSuccess(data.data);
                        if (redirectUrl) {
                            _reactRouter.browserHistory.push(redirectUrl);
                        } else if (!cancelRedirectTo) _reactRouter.browserHistory.push('/kundenkonto');
                    }
                }).catch(function (error) {});
            }
        }
        ...
        value: function resendActivationEmail() {
            ...
            _axios2.default.get('/api/resendActivationLink?login=' + email).then(function (result) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this4.setState({ errorLogin: (0, _extends3.default)({}, _this4.state.errorLogin, {
                ...
                document.getElementById('spinner-box-load').style.display = 'none';
                _this4.setState({ errorLogin: (0, _extends3.default)({}, _this4.state.errorLogin, { login: error.response.data.errors.login[0] }) });
            });
        }
    }, {
        key: 'loginFacebook',
            ...
            FB.login(function (response) {
                ...
                _axios2.default.post('/api/socialAuth', body).then(function (result) {
                    ...
                    if (error.response.status === 404) {
                        document.getElementById('spinner-box-load').style.display = 'none';
                        document.getElementById("op").checked = true;
                        _this5.setState({ errorLogin: (0, _extends3.default)({}, _this5.state.errorLogin, { socialNoEmail: error.response.data }),
                            errorRegistration: (0, _extends3.default)({}, _this5.state.errorRegistration, { socialNoEmail: error.response.data })
                        });
                    }
                });
            }, { scope: 'email' });
            ...
            window.gapiAuth2.signIn().then(function (data) {
                ...
                _axios2.default.post('/api/socialAuth', body).then(function (result) {
                    ...
                    if (error.response.status === 404) {
                        document.getElementById('spinner-box-load').style.display = 'none';
                        document.getElementById("op").checked = true;
                        _this6.setState({ errorLogin: (0, _extends3.default)({}, _this6.state.errorLogin, { socialNoEmail: error.response.data }),
                            errorRegistration: (0, _extends3.default)({}, _this6.state.errorRegistration, { socialNoEmail: error.response.data })
                        });
                    }
                });
            });
        ...
        value: function registerUser(e) {
            ...
            if (!this.state.showInputCode) {
                ...
                _axios2.default.post(url, data).then(function (result) {
                    ...
                    if (result.data.status === 'false') {
                        if (result.data.errorType === 'phone') {
                            ...
                            _this7.setState({ errorRegistration: (0, _extends3.default)({}, _this7.state.errorRegistration, { email: '', phone: phone, password: '', password_confirmation: '', code: '' }), spinner: null });
                        }
                        if (result.data.errorType === 'email') {
                            var email = result.data.message;
                            _this7.setState({ errorRegistration: (0, _extends3.default)({}, _this7.state.errorRegistration, { email: email, phone: '', password: '', password_confirmation: '', code: '' }), spinner: null });
                        }
                    } else if (result.data.smsWasSent) {
                        _this7.setState({ showInputCode: true, spinner: null });
                    } else {
                        document.getElementById("op").checked = false;
                    ...
                    _this7.setState({ errorRegistration: (0, _extends3.default)({}, _this7.state.errorRegistration, { email: email, phone: phone, password: password, password_confirmation: password_confirmation }), spinner: null });
                });
            } else {
                ...
                _axios2.default.post(_url, _data).then(function (response) {
                    ...
                    _this7._loadPersonalData(response.data.token);
                }).catch(function (error) {
                    document.getElementById('spinner-box-load').style.display = 'none';
                    if (error.response.status === 404) {
                        ...
                        _this7.setState({ errorRegistration: (0, _extends3.default)({}, _this7.state.errorRegistration, { code: code }), spinner: null });
                    } else {
                        ...
                        _this7.setState({ errorRegistration: (0, _extends3.default)({}, _this7.state.errorRegistration, { code: _code }), spinner: null });
                    }
                });
            }
        }
        ...
        value: function loginUser(e) {
            ...
            _axios2.default.post(url, data).then(function (result) {
                if (result.data.status === 'false') {
                    document.getElementById('spinner-box-load').style.display = 'none';
                    var errorLogin = _this8.state.errorLogin;
                    ...
                    _this8.setState({ errorLogin: errorLogin });
                } else {
                    window.localStorage.setItem("token", result.data.token);
                    window.axios.defaults.headers.common['Authorization-Token'] = result.data.token;
                    _this8._loadPersonalData(result.data.token);
                }
            }).catch(function (error) {
                document.getElementById('spinner-box-load').style.display = 'none';
                var err = error.response.data.errors,
                ...
                _this8.setState({ errorLogin: (0, _extends3.default)({}, _this8.state.errorLogin, { login: login, password: password }), spinner: null });
            });
        }
    }, {
        key: 'logOut',
        ...
        value: function mapSubcategories(device, i) {
            if (device.name === "Zubehör") return '';
            var currentDeviceName = this.props.params.deviceCategory1 && this.props.params.deviceCategory1.replace(/-/g, ' ');
            var className = '',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    { className: 'image' },
                    _react2.default.createElement('img', { loading: 'lazy', className: 'menuButton', src: '/images/design/' + device.id + 'device.svg' })
                ),
                _react2.default.createElement(
                    'span',
                    { className: 'image' },
                    _react2.default.createElement('img', { loading: 'lazy', className: 'menuButton', src: '/images/design/' + device.id + 'activeDevice.svg' })
                ),
                _react2.default.createElement(
                    'span',
                    { className: 'name' },
        ...
        value: function render() {
            var _state = this.state,
                ...
                showInputCode = _state.showInputCode,
                selectedOption = _state.selectedOption,
                devices = this.props.shop.devices,
            ...
            return _react2.default.createElement(
                'header',
                { onClick: this.globalClick, style: path === 'verkaufen' ? { height: height + 'px' } : null },
                _react2.default.createElement(
                    'div',
                    { className: 'headerAllPages scrolling-header',
                        style: path === 'verkaufen' ? (0, _extends3.default)({}, style) : null },
                    _react2.default.createElement(
                        'div',
                        { className: 'container-fluid', style: { width: '95%' } },
                        _react2.default.createElement(
                            'div',
                            { className: 'row' },
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'select-input-place' },
                                        data && _react2.default.createElement(_reactSelect2.default, {
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: active.place ? 'tel:' + active.place.phoneFull : '', className: 'place-mobile' },
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/phone.svg', alt: '' }),
                                        _react2.default.createElement(
                                            'span',
                                            null,
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'span',
                                            null,
                                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/time-clock.svg', alt: '' })
                                        ),
                                        _react2.default.createElement(
                                            'span',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'ul',
                                        { id: 'header-menu_big', className: 'header-menu' },
                                        _react2.default.createElement(
                                            'li',
                                            null,
                                            _react2.default.createElement(
                                                ...
                                                pathname.split('/')[1] === ' ' ? _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', alt: 'Home', src: '/images/design/home-green.svg' })
                                                ) : _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', alt: 'Home', src: '/images/design/home.svg' })
                                                ),
                                                'Startseite'
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                pathname.split('/')[1] === 'verkaufen' ? _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sell-icon-green.svg' })
                                                ) : _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sell-icon-gray.svg' })
                                                ),
                                                'Verkaufen'
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/kaufen', activeClassName: 'active', id: 'kaufenMenu' },
                                                pathname.split('/')[1] === 'kaufen' ? _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/buy-green.svg' })
                                                ) : _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/buy.svg' })
                                                ),
                                                'Kaufen'
                                            ),
                                            !window.isMobile && _react2.default.createElement(
                                                'div',
                                                { className: 'wrap-sub-category' },
                                                _react2.default.createElement(
                                                    'div',
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { href: 'https://www.ireparatur.ch/', target: '_blank' },
                                                _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/settings-gray.svg' })
                                                ),
                                                'Reparieren'
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                pathname.split('/')[1] === 'kontakt' ? _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/contact-green2.svg' })
                                                ) : _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/contact-gray2.svg' })
                                                ),
                                                'Kontakt'
                                            )
                                        )
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(_loginForm2.default, { registerUser: this.registerUser,
                                        showInputCode: showInputCode,
                                    ...
                                    !this.props.user.isLogin ? _react2.default.createElement(
                                        ...
                                        'span',
                                        { className: 'userButtons lower' },
                                        _react2.default.createElement(
                                            'span',
                                            { className: 'image' },
                                            this.props.user.data && this.props.user.data.systemAddress.first_name && this.props.user.data.systemAddress.first_name.slice(0, 1).toUpperCase()
                                        ),
                                        _react2.default.createElement(
                                            'span',
                                            { className: 'userHello' },
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'span',
                                            { className: 'basket' },
                                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/cart-icon-green.svg', alt: '' }),
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/warenkorb', className: this.props.basket.count > 0 ? 'full' : '' },
                                                'Warenkorb',
                                                this.props.basket.count > 0 && _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    '(',
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/verkaufen/warenkorb', className: this.props.basket.countVerkaufen > 0 ? 'full' : '' },
                                                'Verkaufskorb',
                                                this.props.basket.countVerkaufen > 0 && _react2.default.createElement(
                                                    'span',
                                                    null,
                                                    ' (',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'col-md-12' },
                                this.props.showMenu && _react2.default.createElement(
                                    'nav',
                                    null,
                                    _react2.default.createElement(
                                        'ul',
                                        { id: 'header-menu_small', className: 'header-menu' },
                                        _react2.default.createElement(
                                            'li',
                                            null,
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/', activeClassName: 'active' },
                                                pathname.split('/')[1] === ' ' ? _react2.default.createElement('img', { loading: 'lazy', alt: 'Home', src: '/images/design/home-green.svg' }) : _react2.default.createElement('img', { loading: 'lazy', alt: 'Home', src: '/images/design/home.svg' }),
                                                'Startseite'
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/verkaufen', activeClassName: 'active' },
                                                pathname.split('/')[1] === 'verkaufen' ? _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sell-icon-green.svg' }) : _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sell-icon-gray.svg' }),
                                                'Verkaufen'
                                            )
                                        ),
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/kaufen', activeClassName: 'active', id: 'kaufenMenu' },
                                                pathname.split('/')[1] === 'kaufen' ? _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/buy-green.svg' }) : _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/buy.svg' }),
                                                'Kaufen'
                                            ),
                                            !window.isMobile && _react2.default.createElement(
                                                'div',
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                _reactRouter.Link,
                                                { to: '/kontakt', activeClassName: 'active' },
                                                pathname.split('/')[1] === 'kontakt' ? _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/contact-green2.svg' }) : _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/contact-gray2.svg' }),
                                                'Kontakt'
                                            )
                                        )
                                    )
                                ...
                                !this.props.showMenu && _react2.default.createElement(
                                    'p',
                                    { className: 'searchResultsTitle' },
                                    this.props.searchResults.total,
                                    ' Suchresultate f\xFCr ',
                                    _react2.default.createElement(
                                        'span',
                                        null,
...
exports.default = (0, _reactRouter.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, null, { pure: false })(HeaderAllPages));
...
var _header = __webpack_require__(1618);
...
var LoginMobile = function (_Component) {
    (0, _inherits3.default)(LoginMobile, _Component);

    function LoginMobile() {
        (0, _classCallCheck3.default)(this, LoginMobile);
        return (0, _possibleConstructorReturn3.default)(this, (LoginMobile.__proto__ || Object.getPrototypeOf(LoginMobile)).apply(this, arguments));
    }

    (0, _createClass3.default)(LoginMobile, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_headerMobile2.default, { back: true,
                    handlerBack: function handlerBack() {
                        return _reactRouter.browserHistory.push('/');
                    },
                    title: 'login/register' }),
                _react2.default.createElement(_header2.default, { showMenu: true })
            );
        }
    }]);
    return LoginMobile;
