...
exports.EditUserProfile = undefined;
...
var EditUserProfile = exports.EditUserProfile = function (_Component) {
    (0, _inherits3.default)(EditUserProfile, _Component);

    function EditUserProfile(props) {
        (0, _classCallCheck3.default)(this, EditUserProfile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (EditUserProfile.__proto__ || Object.getPrototypeOf(EditUserProfile)).call(this, props));
        ...
        _this.autocomleteFieldsShippingBilling = _this.autocomleteFieldsShippingBilling.bind(_this);
        _this.changeShippingBillingForm = _this.changeShippingBillingForm.bind(_this);

        return _this;
    }

    (0, _createClass3.default)(EditUserProfile, [{
        ...
        value: function componentDidMount() {
            ...
            */
            ...
            _axios2.default.get('/api/accountData').then(function (result) {
        ...
        key: '_showHideBlocks',
        value: function _showHideBlocks() {
        ...
        value: function sendForm(e) {
            ...
            e.preventDefault();
            var data = new FormData(document.forms.editUserProfileForm);
            document.getElementById('spinner-box-load').style.display = 'block';
            _axios2.default.post('/api/updateAccount', data).then(function (result) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this3.setState({ successMsg: result.data });
                _axios2.default.get('/api/customerAgileData').then(function (data) {
                    if (data.status === 200) {
                        _this3.props.loginSuccess(data.data);
                    }
                });
            });
        }
        ...
        value: function clearForm(e) {
            e.preventDefault();
            var editUserProfileForm = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('.editUserProfileForm input:not([type=radio])'))),
                radioInputs = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('.editUserProfileForm input[type=radio]')));

            editUserProfileForm.forEach(function (item) {
                item.value = '';
            });
            radioInputs.forEach(function (item) {
                item.name !== 'shippingAddress' ? item.checked = false : null;
            });
            this.setState({ inputCheckbox: (0, _extends3.default)({}, this.state.inputCheckbox, { shippingCompany: false, customerCompany: false, systemCompany: false }) });
        }
    }, {
        key: 'autocomleteFieldsShippingBilling',
        value: function autocomleteFieldsShippingBilling(e) {
            var form = document.forms.editUserProfileForm,
                _e$target = e.target,
                name = _e$target.name,
                value = _e$target.value,
                _state2 = this.state,
                isChanged = _state2.isChanged,
        ...
        value: function render() {
            ...
            var _state3 = this.state,
                inputCheckbox = _state3.inputCheckbox,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'editFormWrap clearfix' },
                        _react2.default.createElement(
                            'p',
                            { className: 'successUpd' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'button',
                                        { type: 'submit', className: 'basketSubmit btn' },
                                        'Daten aktualisieren'
                                    )
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement('i', { className: 'fa fa-minus toggle-forMobile' })
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'itemFormWrap' },
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'image' },
                                                this.props.user.data && this.props.user.data.systemAddress && this.props.user.data.systemAddress.first_name && this.props.user.data.systemAddress.last_name && this.props.user.data.systemAddress.first_name.slice(0, 1).toUpperCase() + this.props.user.data.systemAddress.last_name.slice(0, 1).toUpperCase()
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('input', { type: 'text', name: 'first_name', placeholder: 'Vorname', onChange: this.autocomleteFieldsShippingBilling, required: true }),
                                                _react2.default.createElement('input', { type: 'text', name: 'last_name', placeholder: 'Nachname', onChange: this.autocomleteFieldsShippingBilling, required: true })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                            ...
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'inputFullWidth' },
                                                _react2.default.createElement('input', { type: 'text', name: 'phone', placeholder: 'Telefon (mobil)', required: true })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'inputFullWidth' },
                                                _react2.default.createElement('input', { type: 'text', name: 'IBAN', placeholder: 'IBAN', minLength: '21', maxLength: '34' })
                                            ),
                                            !country.countriesList.some(function (item) {
                                                return item.value === country.currentCountry.system_inputCountry.toLowerCase();
                                            ...
                                            _react2.default.createElement(_reactSelect2.default, {
                                                ...
                                                onChange: function onChange(val) {
                                                    return _this4.changeCountry(val, "Sprache");
                                                } }),
                                            _react2.default.createElement(
                                                'label',
                                                { onChange: this.autocomleteFieldsShippingBilling,
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            { className: 'title' },
                                            'Rechnungsadresse',
                                            _react2.default.createElement('i', { className: 'fa fa-plus toggle-forMobile' })
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'itemFormWrap' },
                                            ...
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'personalDataInputHalf' /*onChange={changeNameField}*/ },
                                                _react2.default.createElement('input', { type: 'text',
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('input', { type: 'text', name: 'RechnungStrasse', id: 'customer_route', placeholder: 'Adresse', required: true })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'personalDataInputHalf' },
                                                _react2.default.createElement('input', { type: 'text', name: 'RechnungHausnummer', id: 'customer_street_number', placeholder: 'Nr.', required: true })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'personalDataInputHalf' },
                                                _react2.default.createElement('input', { type: 'text', name: 'RechnungPLZ', placeholder: 'PLZ', id: 'customer_postal_code', required: true }),
                                                _react2.default.createElement('input', { type: 'text', name: 'RechnungStadt', placeholder: 'Stadt', id: 'customer_locality', required: true })
                                            ),
                                            !country.countriesList.some(function (item) {
                                            ...
                                            _react2.default.createElement(_reactSelect2.default, {
                                                ...
                                                searchable: false,
                                                onChange: function onChange(val) {
                                                    return _this4.changeCountry(val, "RechnungLand");
                                                } }),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'inputFullWidth' },
                                                _react2.default.createElement('input', { type: 'text', name: 'RechnungTelefon', placeholder: 'Telefon', onChange: this.changeShippingBillingForm, required: true })
                                            ),
                                            _react2.default.createElement(
                                                'label',
                                                { onChange: this.changeShippingBillingForm,
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: inputCheckbox.shippingAddress === true ? 'hide col-md-4' : "col-md-4" },
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'itemForm' },
                                        _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'inputFullWidth street' },
                                                _react2.default.createElement('input', { type: 'text', name: 'LieferStrasse', id: 'route', placeholder: 'Strasse', required: !inputCheckbox.shippingAddress })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'personalDataInputHalf' },
                                                _react2.default.createElement('input', { type: 'text', name: 'LieferHausnummer', id: 'street_number', placeholder: 'Nr.', required: !inputCheckbox.shippingAddress })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'personalDataInputHalf' },
                                                _react2.default.createElement('input', { type: 'text', name: 'LieferPLZ', placeholder: 'PLZ', id: 'postal_code', required: !inputCheckbox.shippingAddress }),
                                                _react2.default.createElement('input', { type: 'text', name: 'LieferStadt', placeholder: 'Stadt', id: 'locality', required: !inputCheckbox.shippingAddress })
                                            ),
                                            !country.countriesList.some(function (item) {
                                            ...
                                            _react2.default.createElement(_reactSelect2.default, {
                                                ...
                                                searchable: false,
                                                onChange: function onChange(val) {
                                                    return _this4.changeCountry(val, "LieferLand");
                                                } }),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'inputFullWidth phone' },
                                                _react2.default.createElement('input', { type: 'text', name: 'LieferTelefon', placeholder: 'Telefon', onChange: this.changeShippingBillingForm, required: !inputCheckbox.shippingAddress })
                                            ),
                                            _react2.default.createElement(
                                                'label',
                                                { onChange: this.changeShippingBillingForm, className: 'labelCompany' },
                                                _react2.default.createElement('input', { type: 'checkbox',
...
function mapDispatchToProps(dispatch) {
    return {
        loginSuccess: (0, _redux.bindActionCreators)(_user.loginSuccess, dispatch)
    };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(EditUserProfile);
