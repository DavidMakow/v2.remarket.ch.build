...
var RepairPageDeviceSection = function (_Component) {
    (0, _inherits3.default)(RepairPageDeviceSection, _Component);

    function RepairPageDeviceSection(props) {
        (0, _classCallCheck3.default)(this, RepairPageDeviceSection);

        var _this = (0, _possibleConstructorReturn3.default)(this, (RepairPageDeviceSection.__proto__ || Object.getPrototypeOf(RepairPageDeviceSection)).call(this, props));
    ...
    (0, _createClass3.default)(RepairPageDeviceSection, [{
        ...
        value: function loadDevices() {
            ...
            axios.get('/api/getRepairGroups').then(function (response) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this2.setState({ dataDevices: response.data.repairGroups });
            });
        }
    }, {
        key: 'mapDevices',
        value: function mapDevices(item) {
            return _react2.default.createElement(
                _reactRouter.Link,
                { to: '/reparieren/' + item.name.toLowerCase().replace(/ /g, '-') + '-' + item.id,
                    className: 'item-device',
                    key: item.id },
                _react2.default.createElement(
                    'div',
                    { className: 'image' },
                    _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/repair_device_category-' + item.id + '.png', alt: '' })
                ),
                _react2.default.createElement(
                    'p',
                    { className: 'title' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'p',
                            { className: 'title' },
                            'Welches Ger\xE4t haben Sie?'
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'wrap-devices' },
    ...
    return RepairPageDeviceSection;
}(_react.Component);

exports.default = RepairPageDeviceSection;
