...
var codes = [{ value: 'Vorwahl', label: 'Vorwahl' }, { value: '079', label: '079' }, { value: '078', label: '078' }, { value: '077', label: '077' }, { value: '076', label: '076' }, { value: '075', label: '075' }, { value: '0049 (DE)', label: '0049 (DE)' }, { value: '0033 (FR)', label: '0033 (FR)' }, { value: 'Andere', label: 'Andere' }];

var CompanyPage = function (_Component) {
    (0, _inherits3.default)(CompanyPage, _Component);

    function CompanyPage(props) {
        (0, _classCallCheck3.default)(this, CompanyPage);

        var _this = (0, _possibleConstructorReturn3.default)(this, (CompanyPage.__proto__ || Object.getPrototypeOf(CompanyPage)).call(this, props));
        ...
        _this.changePhoneCode = _this.changePhoneCode.bind(_this);

        return _this;
    }

    (0, _createClass3.default)(CompanyPage, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            $('button.registerNow').on('click', function () {
                return $("html, body").animate({ scrollTop: $('#form').offset().top }, 600);
            });
        }
    }, {
        key: 'changePhoneCode',
        value: function changePhoneCode(e) {
            var value = e.value;

            this.setState({ phoneCodes: (0, _extends3.default)({}, this.state.phoneCodes, { currentCode: value }) });
        }
    }, {
        key: 'verifyCaptchaCallback',
        value: function verifyCaptchaCallback() {
        ...
        value: function sendForm(e) {
            ...
            e.preventDefault();
            var data = new FormData(document.forms.companyForm),
                captcha = this.state.captcha;

            if (captcha.isCheckCaptcha || !window.isGoogleConnection) {
                _axios2.default.post('/api/registerCompany', data).then(function (result) {
                    _this2.setState({ successMsg: result.data });
                }).catch(function (error) {
                    if (error.response.status === 404) {
                        _this2.setState({ errors: (0, _extends3.default)({}, _this2.state.errors, { phoneNumber: error.response.data }) });
                    }
                });
            } else {
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'p',
                                        { className: 'text' },
                                        'Registrieren Sie sich als Firmenkunde und kommen Sie in den Genuss von einem hervorragenden Service, mit dem Ihr Unternehmen noch leistungsf\xE4higer wird.'
                                    ),
                                    _react2.default.createElement(
                                        'button',
                                        { className: 'btn registerNow' },
                                        'Jetzt registrieren',
                                        _react2.default.createElement(
                                            'span',
                                            null,
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: 'tel:+61 511 22 44', className: 'callToUs' },
                                        'oder rufen Sie uns an 061 511 22 44'
                                    )
                                )
                            )
                        ),
                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/companyPhone.png', className: 'phone' }),
                        _react2.default.createElement('img', { loading: 'lazy', className: 'bigTriangle', src: '/images/design/company-triangle.svg', alt: '' }),
                        _react2.default.createElement('img', { loading: 'lazy', className: 'grayTriangle', src: '/images/design/company-triangle-gray.svg', alt: '' })
                    ),
                    _react2.default.createElement(
                        'section',
                        { className: 'corporate' },
                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/corporateCustomers.jpg', alt: '' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'wrapCorporate' },
                            _react2.default.createElement(
                                'div',
                                { className: 'container' },
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'col-sm-6 col-sm-push-6 right-side' },
                                            _react2.default.createElement(
                                                'p',
                                                { className: 'title' },
                                                'Vorteile'
                                            ...
                                            _react2.default.createElement(
                                                'p',
                                                { className: 'text' },
                                                'Als Person, die f\xFCr Smartphones und Tablets in Ihrem Unternehmen verantwortlich ist, profitieren Sie von unz\xE4hligen Vorteilen bei remarket. Wir wissen, wie wichtig mobile Ger\xE4te in Ihrem t\xE4glichen Gesch\xE4ft sind, und haben und darauf spezialisiert, Reparaturen, Ank\xE4ufe und Verk\xE4ufe f\xFCr Firmen und der schnellst m\xF6glichen Zeit durchzuf\xFChren. F\xFCr den Fall, dass ein Schaden nicht von Ihrer Versicherung abgedeckt ist, helfen wir als zuverl\xE4ssiger Partner und \xFCbernehmen alle Reparatur Services.'
                                            )
                                        )
                                    )
                                )
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'p',
                                            { className: 'text' },
                                            'Auch f\xFCr Versicherungsunternehmen bieten wir attraktive Service rund um die Smartphone und Tablet Reparatur. iReparatur.ch ist Ihr kompetenter Partner f\xFCr Reparaturen im Fall eines Versicherungsanspruchs, und stellt sicher, dass Ihr Schadensvolumen so klein wie m\xF6glich ist.'
                                        )
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'image' },
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/company-insurance.png', alt: '' })
                                    )
                                )
                            )
                        )
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    'li',
                                                    null,
                                                    _react2.default.createElement('span', { className: 'circleOk' }),
                                                    'Zahlung per Rechnung m\xF6glich'
                                                ),
                                                _react2.default.createElement(
                                                    'li',
                                                    null,
                                                    _react2.default.createElement('span', { className: 'circleOk' }),
                                                    'Keine Terminvereinbarung n\xF6tig'
                                                ),
                                                _react2.default.createElement(
                                                    'li',
                                                    null,
                                                    _react2.default.createElement('span', { className: 'circleOk' }),
                                                    'Rabatte auf gr\xF6ssere Reparaturvolumen m\xF6glich'
                                                )
                                            )
                                        ),
                                        _react2.default.createElement(
                                            'button',
                                            { type: 'button', className: 'btn registerNow' },
                                            'Anmelden',
                                            _react2.default.createElement(
                                                'span',
                                                null,
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    null,
                                                    _react2.default.createElement('span', { className: 'circleOk' }),
                                                    'Bonus bei gr\xF6sseren Verkaufsmengen'
                                                )
                                            )
                                        ),
                                        _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'wrapSponsors' },
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/dieMob.png', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/stam.svg', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/bayer.svg', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/lions.svg', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/endress.png', alt: '' })
                                    )
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'wrapSponsors' },
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/alpiq.png', className: 'alpiq' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/migros.png', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/wr.png', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/tesla.svg', alt: '' }),
                                        _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/sponsors/bell.svg', alt: '' })
                                    )
                                )
                            )
                        )
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'col-sm-10 col-sm-push-1 mainPart' },
                                        _react2.default.createElement(
                                            'form',
                                            { action: '#', name: 'companyForm', className: 'companyForm', onSubmit: this.sendForm },
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('input', { type: 'text', name: 'firmenname', placeholder: 'Firmenname', required: true }),
                                                _react2.default.createElement('input', { type: 'text', name: 'ihrVorname', placeholder: 'Ihr Vorname', required: true }),
                                                _react2.default.createElement('input', { type: 'text', name: 'ihrNachname', placeholder: 'Ihr Nachname', required: true }),
                                                _react2.default.createElement('input', { type: 'email', name: 'ihreEmail', placeholder: 'Ihre E-Mail', required: true }),
                                                _react2.default.createElement(
                                                    'div',
                                                    ...
                                                    _react2.default.createElement('input', { type: 'text', name: 'phoneNumber', placeholder: 'Ihre Handynummer', required: true, onChange: this.changeInput })
                                                ),
                                                this.state.errors.phoneNumber && _react2.default.createElement(
                                                    'span',
                                                    { className: 'error' },
                                                ...
                                                captcha.errorCaptcha && _react2.default.createElement(
                                                    'p',
                                                    { style: { color: 'red' } },
                                                    'Bitte best\xE4tigen Sie das Sie kein Roboter sind'
                                                )
                                            ),
                                            _react2.default.createElement(
                                                'button',
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/quotes.svg', alt: '' })
                                        )
                                    )
                                )
                            )
...
var _companyPage = __webpack_require__(687);

var _companyPage2 = _interopRequireDefault(_companyPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var CompanyPageMobile = function (_Component) {
    (0, _inherits3.default)(CompanyPageMobile, _Component);

    function CompanyPageMobile(props) {
        (0, _classCallCheck3.default)(this, CompanyPageMobile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (CompanyPageMobile.__proto__ || Object.getPrototypeOf(CompanyPageMobile)).call(this, props));
    ...
    (0, _createClass3.default)(CompanyPageMobile, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
    ...
    return CompanyPageMobile;
}(_react.Component);

CompanyPageMobile.propTypes = {};
CompanyPageMobile.defaultProps = {};

exports.default = CompanyPageMobile;
