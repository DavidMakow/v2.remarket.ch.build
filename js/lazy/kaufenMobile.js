...
var Kaufen = function (_Component) {
    (0, _inherits3.default)(Kaufen, _Component);

    function Kaufen(props) {
        (0, _classCallCheck3.default)(this, Kaufen);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Kaufen.__proto__ || Object.getPrototypeOf(Kaufen)).call(this, props));

        _this.state = {};
        return _this;
    }

    (0, _createClass3.default)(Kaufen, [{
        key: 'render',
...
Kaufen.propTypes = {};
Kaufen.defaultProps = {};
exports.default = (0, _reactI18next.withTranslation)()(Kaufen);
...
exports.KaufenMobile = undefined;
...
var _kaufen = __webpack_require__(667);

var _kaufen2 = _interopRequireDefault(_kaufen);
...
var KaufenMobile = exports.KaufenMobile = function (_Component) {
    (0, _inherits3.default)(KaufenMobile, _Component);

    function KaufenMobile(props) {
        (0, _classCallCheck3.default)(this, KaufenMobile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (KaufenMobile.__proto__ || Object.getPrototypeOf(KaufenMobile)).call(this, props));

        _this.state = {
            titleForHead: _this.props.params.deviceCategory1 || 'Kategorien'

            //this.showFiltersMobile = this.showFiltersMobile.bind(this)
        };_this.handleBackFilter = _this.handleBackFilter.bind(_this);
        _this._defineTitleHead = _this._defineTitleHead.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(KaufenMobile, [{
        ...
        value: function _defineTitleHead(titleForHead) {
            this.setState({ titleForHead: titleForHead });
        }
        /*showFiltersMobile(){
        ...
        value: function render() {
            ...
            var childrenWithProps = _react2.default.Children.map(this.props.children, function (child) {
                return _react2.default.cloneElement(child, {
                    ...
                    defineTitleHeadMobile: _this2._defineTitleHead,
                    handleBackFilter: _this2.handleBackFilter
                });
            });
            return _react2.default.createElement(
                'div',
                { className: 'buyPage' },
                _react2.default.createElement(_headerMobile2.default, { menu: titleForHead !== "Filters",
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(KaufenMobile);
