...
exports.PageDownloadCoupon = undefined;
...
var PageDownloadCoupon = exports.PageDownloadCoupon = function (_Component) {
    (0, _inherits3.default)(PageDownloadCoupon, _Component);

    function PageDownloadCoupon(props) {
        (0, _classCallCheck3.default)(this, PageDownloadCoupon);

        var _this = (0, _possibleConstructorReturn3.default)(this, (PageDownloadCoupon.__proto__ || Object.getPrototypeOf(PageDownloadCoupon)).call(this, props));
    ...
    (0, _createClass3.default)(PageDownloadCoupon, [{
        ...
        value: function downloadPDF() {
            ...
            _axios2.default.get('/api/generateCouponPdf?customerShortcode=' + shortcode).then(function (result) {
                document.getElementById('spinner-box-load').style.display = 'none';
                windowPdf.location = '/' + result.data;
            }).catch(function (error) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this2.setState({ errorMsg: error.response.data });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h1',
                    null,
                    'Ihr pers\xF6nlicher Gutschein'
                ),
                _react2.default.createElement(
                    'button',
                    { className: 'btn downloadPDF', onClick: this.downloadPDF },
                    'Jetzt 20.- ',
    ...
    return PageDownloadCoupon;
}(_react.Component);

PageDownloadCoupon.propTypes = {};
PageDownloadCoupon.defaultProps = {};

exports.default = (0, _reactRedux.connect)(null, null)(PageDownloadCoupon);
...
var _PageDownloadCoupon = __webpack_require__(686);

var _PageDownloadCoupon2 = _interopRequireDefault(_PageDownloadCoupon);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var PageDownloadCouponMobile = function (_Component) {
    (0, _inherits3.default)(PageDownloadCouponMobile, _Component);

    function PageDownloadCouponMobile(props) {
        (0, _classCallCheck3.default)(this, PageDownloadCouponMobile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (PageDownloadCouponMobile.__proto__ || Object.getPrototypeOf(PageDownloadCouponMobile)).call(this, props));
    ...
    (0, _createClass3.default)(PageDownloadCouponMobile, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'downloadCoupon' },
                    _react2.default.createElement(_PageDownloadCoupon2.default, { params: this.props.params })
                )
            );
        }
    }]);
    return PageDownloadCouponMobile;
}(_react.Component);

PageDownloadCouponMobile.propTypes = {};
PageDownloadCouponMobile.defaultProps = {};

exports.default = PageDownloadCouponMobile;
