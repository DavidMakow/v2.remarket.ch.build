...
exports.TrackingInfo = undefined;
...
var TrackingInfo = exports.TrackingInfo = function (_Component) {
    (0, _inherits3.default)(TrackingInfo, _Component);

    function TrackingInfo(props) {
        (0, _classCallCheck3.default)(this, TrackingInfo);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TrackingInfo.__proto__ || Object.getPrototypeOf(TrackingInfo)).call(this, props));

        _this._loadTrackingInfo = function () {
            var _this$props$params = _this.props.params,
                type = _this$props$params.type,
                shortcode = _this$props$params.shortcode;

            document.getElementById('spinner-box-load').style.display = 'block';
            _axios2.default.get('/api/basketTracking?type=' + type + '&shortcode=' + shortcode).then(function (data) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this.setState({ trackingData: data.data });
            }).catch(function (error) {
                document.getElementById('spinner-box-load').style.display = 'none';
                if (error.response.status === 404) {
                    _this.setState({ errorMsg: 'Keine Information' });
                }
            });
        };

        _this.mapTrackingData = function (item, i) {
            return _react2.default.createElement(
                'div',
                { className: 'itemTracking', key: i },
                _react2.default.createElement(
                    'h1',
                    null,
                    'Versandinformationen zum Auftrag ',
                    item.shortcode
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        null,
                        'Aktueller Standort Ihres Pakets gem\xE4ss Post'
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'wrapEvents' },
                    item.events.length === 0 && _react2.default.createElement(
                        'p',
                        { className: 'noInfo' },
                        'Keine Information'
                    ),
                    item.events.map(function (item, i) {
                        return _react2.default.createElement(
                            'p',
                            { key: i, className: 'itemEvent' },
                            item.date,
                            ': ',
                            item.description,
                            item.location.trim() && ' - ',
    ...
    (0, _createClass3.default)(TrackingInfo, [{
        ...
        value: function render() {
            var _state = this.state,
                ...
                trackingData = _state.trackingData;

            return _react2.default.createElement(
                'div',
                { className: 'container trackingInfo' },
                _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    _react2.default.createElement(
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(TrackingInfo);
...
var _trackingInfo = __webpack_require__(690);

var _trackingInfo2 = _interopRequireDefault(_trackingInfo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TrackingInfoMobile = function (_Component) {
    (0, _inherits3.default)(TrackingInfoMobile, _Component);

    function TrackingInfoMobile(props) {
        (0, _classCallCheck3.default)(this, TrackingInfoMobile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TrackingInfoMobile.__proto__ || Object.getPrototypeOf(TrackingInfoMobile)).call(this, props));
    ...
    (0, _createClass3.default)(TrackingInfoMobile, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(_trackingInfo2.default, { params: this.props.params })
            );
        }
    }]);
    return TrackingInfoMobile;
}(_react.Component);

TrackingInfoMobile.propTypes = {};
TrackingInfoMobile.defaultProps = {};

exports.default = TrackingInfoMobile;
