...
var _extends7 = __webpack_require__(54);
...
var _deliveryByPostSummaryPopup = __webpack_require__(1615);

var _deliveryByPostSummaryPopup2 = _interopRequireDefault(_deliveryByPostSummaryPopup);

var _deliverySuccessLetter = __webpack_require__(1561);
                    ...
                    if (_this5.state.payMethod.method === 'Datatrans') {
                        ...
                        Datatrans.startPayment({ 'form': '#paymentForm',
                            'closed': function closed() {
                                _index2.default.get('/api/closePaymentWindow?basketShortcode=' + result.data.basketShortcode + '&\n                                                                    totalPrice=' + result.data.totalPrice + '&paymentMethod=' + _this5.state.payMethod.payMethodDatatrans);
...
var _deliveryByPost = __webpack_require__(1560);

var _deliveryByPost2 = _interopRequireDefault(_deliveryByPost);

var _deliveryByBicycle = __webpack_require__(1616);

var _deliveryByBicycle2 = _interopRequireDefault(_deliveryByBicycle);

var _bookAnAppointment = __webpack_require__(1617);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    activeNavItem === 'post' && _react2.default.createElement(_deliveryByPost2.default, { totalPrice: totalPrice,
                        model: model }),
                    activeNavItem === 'bicycle' && _react2.default.createElement(_deliveryByBicycle2.default, { totalPrice: totalPrice,
                        model: model }),
                                            ...
                                            basketData.shippingMethod && _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        'span',
                                                        { className: 'price' },
                                                        Math.round(+basketData.shippingMethod.price * 100) / 100,
                                                        ' ',
                                                        window.currencyValue
                                                    )
                                                ),
...
var _extends4 = __webpack_require__(54);
...
var _repairPageDeliveryForm = __webpack_require__(1614);
