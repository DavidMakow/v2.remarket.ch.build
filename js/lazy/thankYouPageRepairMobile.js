...
var ThankYouPage = exports.ThankYouPage = function (_Component) {
    ...
    (0, _createClass3.default)(ThankYouPage, [{
        ...
        value: function componentDidMount() {
            ...
            var basketData = JSON.parse(window.localStorage.getItem('basketDataRepair')),
                totalPrice = 0,
                selectedOptions = [];

            document.getElementById('spinner-box-load').style.display = 'block';
            if (basketData) {
                _axios2.default.get('/api/getModelRepairList?modelId=' + basketData.modelId).then(function (result) {
                    document.getElementById('spinner-box-load').style.display = 'none';
                    totalPrice = _this2._getPrice(basketData.selectedOptions, result.data.repairList, basketData.shippingMethod);
                    selectedOptions = [].concat((0, _toConsumableArray3.default)(basketData.selectedOptions));
                    ...
                    _this2.setState({ basketData: basketData, selectedOptions: selectedOptions, totalPrice: totalPrice, repairList: result.data.repairList });
                });
            } else {
                document.getElementById('spinner-box-load').style.display = 'none';
            }
        ...
        key: '_getPrice',
        value: function _getPrice(selectedRepairOptions, repairList, shippingMethod) {
            ...
            repairList.forEach(function (itemRepair) {
        ...
        value: function mapBasketItemsDevices(item, i) {
            if (item.productTypeId !== 11) {
                var selectedRepairOptions = this.state.selectedOptions,
...
var _thankYouPage = __webpack_require__(675);
