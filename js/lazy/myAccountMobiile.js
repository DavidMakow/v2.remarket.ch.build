...
exports.MyAccountMobiile = undefined;
...
var MyAccountMobiile = exports.MyAccountMobiile = function (_Component) {
    (0, _inherits3.default)(MyAccountMobiile, _Component);

    function MyAccountMobiile(props) {
        (0, _classCallCheck3.default)(this, MyAccountMobiile);

        var _this = (0, _possibleConstructorReturn3.default)(this, (MyAccountMobiile.__proto__ || Object.getPrototypeOf(MyAccountMobiile)).call(this, props));
        ...
        _this.setTitleForHead = _this.setTitleForHead.bind(_this);
        _this.clickPayoutBtn = _this.clickPayoutBtn.bind(_this);

        return _this;
    }

    (0, _createClass3.default)(MyAccountMobiile, [{
        ...
        key: 'setTitleForHead',
        value: function setTitleForHead(path) {
            if (path.includes('passwort-aendern')) this.setState({ titleForHead: 'Passwort ändern' });else if (path.includes('profile')) this.setState({ titleForHead: 'Profil bearbeiten' });else if (path.includes('auszahlung')) this.setState({ titleForHead: 'Auszahlung' });else this.setState({ titleForHead: 'Bestellübersicht' });
        }
    }, {
        key: 'clickPayoutBtn',
        value: function clickPayoutBtn() {
            $('.tableCredits').hide();
            $('.formCredits').show();
        ...
        value: function render() {
            ...
            var childrenWithProps = _react2.default.Children.map(this.props.children, function (child) {
                return _react2.default.cloneElement(child, {
                    clickPayoutBtn: _this2.clickPayoutBtn
                });
            });
            return _react2.default.createElement(
                'div',
                { className: 'myAccount-mobile' },
                _react2.default.createElement(_headerMobile2.default, { menu: false,
                    back: true,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { to: '/kundenkonto', activeClassName: 'active' },
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/overview_myAccount.svg', alt: '' }),
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/overview_myAccount_active.svg', alt: '' }),
                            '\xDCbersicht'
                        ),
                        _react2.default.createElement(
                            _reactRouter.Link,
                            { to: '/kundenkonto/profile', activeClassName: 'active' },
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/profile_myAccount.svg', alt: '' }),
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/profile_myAccount_active.svg', alt: '' }),
                            'Mein Profil'
                        ),
                        _react2.default.createElement(
                            _reactRouter.Link,
                            { to: '/kundenkonto/passwort-aendern/', activeClassName: 'active' },
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/key_myAccount.svg', alt: '' }),
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/key_myAccount_active.svg', alt: '' }),
                            'Passwort'
                        ),
                        _react2.default.createElement(
                            'a',
                            { href: '#', onClick: this.logOut, className: 'logout' },
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/log-out_myAccount.svg', alt: '' }),
                            _react2.default.createElement('img', { loading: 'lazy', src: '/images/design/log-out_myAccount.svg', alt: '' }),
                            'Ausloggen'
                        )
                    )
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, null, { pure: false })(MyAccountMobiile);
