...
var RepairPageModelSection = function (_Component) {
    (0, _inherits3.default)(RepairPageModelSection, _Component);

    function RepairPageModelSection(props) {
        (0, _classCallCheck3.default)(this, RepairPageModelSection);

        var _this = (0, _possibleConstructorReturn3.default)(this, (RepairPageModelSection.__proto__ || Object.getPrototypeOf(RepairPageModelSection)).call(this, props));

        _this.state = {
            dataModels: []
        };

        _this.getModels = _this.getModels.bind(_this);
        _this.mapModels = _this.mapModels.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(RepairPageModelSection, [{
        ...
        value: function getModels() {
            ...
            var deviceParam = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props.params.device;

            var device = deviceParam.slice(0, deviceParam.lastIndexOf('-')).replace(/-/g, ' ');
            document.getElementById('spinner-box-load').style.display = 'block';
            axios.get('/api/getRepairModels?repairGroup=' + device).then(function (response) {
                document.getElementById('spinner-box-load').style.display = 'none';
                _this2.setState({ dataModels: response.data.repairModels });
                window.scrollTo(0, document.querySelector('.select-device').offsetTop - 110);
            });
        }
    }, {
        key: 'mapModels',
        value: function mapModels(item) {
            var deviceName = this.props.params.device;
            return _react2.default.createElement(
                _reactRouter.Link,
                { to: '/reparieren/' + deviceName + '/' + item.name.toLowerCase().replace(/ /g, '-') + '-' + item.id,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { className: 'nav' },
                            'Reparieren >> ',
                            this.props.params.device.replace(/-/g, ' '),
                            ' >> ',
                            _react2.default.createElement(
                                'span',
                                null,
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'wrap-devices nav-menu' },
    ...
    return RepairPageModelSection;
}(_react.Component);

exports.default = RepairPageModelSection;
