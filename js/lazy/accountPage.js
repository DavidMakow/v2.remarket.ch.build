...
var AccountPage = exports.AccountPage = function (_Component) {
    (0, _inherits3.default)(AccountPage, _Component);

    function AccountPage(props) {
        (0, _classCallCheck3.default)(this, AccountPage);

        var _this = (0, _possibleConstructorReturn3.default)(this, (AccountPage.__proto__ || Object.getPrototypeOf(AccountPage)).call(this, props));
    ...
    (0, _createClass3.default)(AccountPage, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'container content myAccount' },
                _react2.default.createElement(
                    'div',
                    { className: 'row wrap-myAccount' },
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-3' },
                        _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-9 mainContent' },
                        this.props.children
                    )
                )
            );
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, null, { pure: false })(AccountPage);
